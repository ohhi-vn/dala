defmodule Dala.Ui.Style do
  ...
  ## Defining styles
      ...
      @header  %Dala.Ui.Style{props: %{text_size: :xl, text_color: :white, background: :primary, padding: 16}}
      @btn     %Dala.Ui.Style{props: %{text_size: :lg, text_color: :white, padding: 12}}
      @btn_primary  Dala.Ui.Style.put(@btn, :background, :blue_700)
      @btn_danger   Dala.Ui.Style.put(@btn, :background, :red_500)
