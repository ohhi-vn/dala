defmodule Dala.ComponentRegistry do
  ...
  This module delegates to `Dala.Ui.ComponentRegistry` for managing
  component processes in the UI tree.
  """

  alias Dala.Ui.ComponentRegistry

  @doc """
  Start the component registry.
  """
  @spec start_link(keyword()) :: GenServer.on_start()
  defdelegate start_link(opts \\ []), to: ComponentRegistry
  ...
  defdelegate register(screen_pid, id, module, component_pid), to: ComponentRegistry

  @doc """
  Look up the component pid for a given key.
  """
  @spec lookup(pid(), atom(), module()) :: {:ok, pid()} | {:error, :not_found}
  defdelegate lookup(screen_pid, id, module), to: ComponentRegistry

  @doc """
  Remove a component registration.
  """
  @spec deregister(pid(), atom(), module()) :: :ok
  defdelegate deregister(screen_pid, id, module), to: ComponentRegistry
  ...
  defdelegate reconcile(screen_pid, active_keys), to: ComponentRegistry
end
