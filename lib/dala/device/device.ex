defmodule Dala.Device.Device do
  @compile {:nowarn_undefined, [:Nx]}
  @moduledoc """
  Cross-platform device events and queries.

  `Dala.Device.Device` is the single subscription point for OS-level events that exist
  ...
  ## Subscribe
      ...
      Dala.Device.Device.subscribe()             # default categories
      Dala.Device.Device.subscribe(:all)         # everything
      Dala.Device.Device.subscribe([:app, :power])
  ...
  ## Queries
      ...
      Dala.Device.Device.battery_level()      # 0..100 | -1 if unknown
      Dala.Device.Device.battery_state()      # :unplugged | :charging | :full | :unknown
      Dala.Device.Device.thermal_state()      # :nominal | :fair | :serious | :critical
      Dala.Device.Device.low_power_mode?()    # boolean
      Dala.Device.Device.foreground?()        # boolean
      Dala.Device.Device.os_version()         # binary
      Dala.Device.Device.model()              # binary
  """
  ...
  Default is `#{inspect(@default_categories)}`.
      ...
      Dala.Device.Device.subscribe()
      Dala.Device.Device.subscribe(:thermal)
      Dala.Device.Device.subscribe([:app, :power, :thermal])
      Dala.Device.Device.subscribe(:all)
  """
  ...
  def battery_level do
    {_state, pct} = Dala.Platform.Native.device_battery_state()
    pct
  end
  ...
  defp maybe_set_dispatcher do
    try do
      Dala.Platform.Native.device_set_dispatcher(self())
      :ok
    rescue
