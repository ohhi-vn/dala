defmodule Dala.App.App do
  ...
  defmacro __using__(opts) do
    ...
    quote do
      ...
      Installs `Dala.Platform.NativeLogger` so all Elixir Logger output is routed to
      ...
      def start do
        ...
        # and store it so Dala.Ui.Renderer picks it up on every render.
        ...
        ensure_started(Dala.Platform.State)
        ...
        ensure_started(Dala.Device.Device)
