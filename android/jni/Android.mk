...
# Place this in mob/android/jni/Android.mk

LOCAL_PATH := $(call my-dir)

# ============================================================================
# Rust library (mob_beam)
# ============================================================================
include $(CLEAR_VARS)

LOCAL_MODULE := mob_beam_rust
LOCAL_SRC_FILES := rust/target/$(TARGET_ARCH_ABI)/release/libmob_beam.so

# Ensure Rust is built before this module
LOCAL_ADDITIONAL_DEPENDENCIES := \
    $(LOCAL_PATH)/rust/target/$(TARGET_ARCH_ABI)/release/libmob_beam.so
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)
LOCAL_STATIC_LIBRARIES := mob_beam_rust
...
# ============================================================================
$(LOCAL_PATH)/rust/target/%/release/libmob_beam.so:
